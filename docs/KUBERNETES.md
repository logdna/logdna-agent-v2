...
```console
kubectl apply -f https://raw.githubusercontent.com/logdna/logdna-agent-v2/3.0/k8s/agent-namespace.yaml
kubectl create secret generic logdna-agent-key -n logdna-agent --from-literal=logdna-agent-key=<YOUR LOGDNA INGESTION KEY>
kubectl apply -f https://raw.githubusercontent.com/logdna/logdna-agent-v2/3.0/k8s/agent-resources.yaml
```
...
```console
kubectl delete -f https://raw.githubusercontent.com/logdna/logdna-agent-v2/3.0/k8s/agent-namespace.yaml
```
